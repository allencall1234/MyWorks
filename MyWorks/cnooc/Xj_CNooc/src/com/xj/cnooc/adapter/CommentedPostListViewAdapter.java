...
public class CommentedPostListViewAdapter extends BaseAdapter
{
	...
	public CommentedPostListViewAdapter(List<ReplyPostBean> list, Context context) 
	{
		super();
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null) 
		{
			convertView = LayoutInflater.from(context).inflate(R.layout.post_detailes_item_view, null);
			
			viewHolder = new ViewHolder();
			viewHolder.iv_head_img = (ImageView) convertView.findViewById(R.id.iv_head_img);
			viewHolder.tv_replyer = (TextView) convertView.findViewById(R.id.tv_replyer);
...
//			viewHolder.tv_reply_account = (TextView) convertView.findViewById(R.id.tv_reply_account);
...
//		viewHolder.tv_reply_account.setText("回复(" + bean.getReply_account() + ")");
		...
		ImageLoader.getInstance().displayImage(HttpURL.SERVICE_URL + bean.getReply_post_img(), viewHolder.iv_head_img, ImageLoadOptions.getOptions());
