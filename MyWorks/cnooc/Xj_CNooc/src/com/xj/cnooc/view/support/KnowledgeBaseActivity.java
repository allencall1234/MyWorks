 ...
 * 2015-9-7
 */
public class KnowledgeBaseActivity extends BaseActivity implements IXListViewListener,OnClickListener{
...
//	private RelativeLayout rellayout_setting;
	...
	Handler handler=new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				progress=ProgressDialog.show(KnowledgeBaseActivity.this,"", "正在加载数据,请稍候...");
				UserHttpBiz.getKnowledgeBseListData(curragePage, num, "", new HttpDataCallBack() {
					
					@Override
					public void HttpSuccess(String _result) {
						progress.dismiss();
						adapter = new KnowledgeBaseListAdapter(KnowledgeBaseActivity.this, getData(_result));
						if(totalNum <= 10){
					...
					public void HttpFail(int ErrCode) {
						progress.dismiss();
						Toast.makeText(KnowledgeBaseActivity.this, "网络请求失败,请检查您的网络！", 1).show();
					}
				});
				break;
			...
			case 2:
					...
					public void HttpSuccess(String _result) {
						if(knowledgeType.equals("1") || knowledgeType.equals("2")){
							try {
								...
								intent.setClass(KnowledgeBaseActivity.this, KnowledgeBaseDetailActivity.class);
						...
						if(knowledgeType.equals("3") || knowledgeType.equals("4")){
							...
							try {
								...
								for (int i = 0; i < jsonArray.length(); i++) {
									...
									parentId = jsonArray.getJSONObject(i).getString("parentId");
							...
							Intent intent=new Intent();
							intent.setClass(KnowledgeBaseActivity.this, VideoKnowledgeBaseDetailActivity.class);
							Bundle bundle=new Bundle();
				...
				break;
			case 3:
				UserHttpBiz.getKnowledgeBaseNum(knowledgeId, MyApp.globelUser.getAccountid(), MyApp.globelUser.getType(), new HttpDataCallBack() 
				{
					@Override
					public void HttpSuccess(String _result)
					{
...
//							{
//								LoginActivity.recordtotal = object.getInt("recordtotal");
//							}
//						}
//						catch (JSONException e) 
//						{
...
//			break;
		...
		case R.id.et_seacher:
			intent.setClass(KnowledgeBaseActivity.this, KnowledgeSeachActivity.class);
