...
//		btn_setting = (Button) findViewById(R.id.btn_setting);
	...
	private void showOrHideView(boolean checkState) {
		// TODO Auto-generated method stub
		findViewById(R.id.rl_switch_voice).setVisibility(checkState?View.VISIBLE:View.GONE);
		findViewById(R.id.rl_switch_vibrate).setVisibility(checkState?View.VISIBLE:View.GONE);
		findViewById(R.id.view1).setVisibility(checkState?View.VISIBLE:View.GONE);
		findViewById(R.id.view2).setVisibility(checkState?View.VISIBLE:View.GONE);
	}
}
