...
public class DownloadListViewAdapter extends BaseAdapter
{
	...
	public DownloadListViewAdapter(List<AttachmentBean> att_list, Context context) 
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null) 
		{
			convertView = LayoutInflater.from(context).inflate(R.layout.download_listitem_view, null);
			viewHolder = new ViewHolder();
			viewHolder.tv_fileTitle = (TextView) convertView.findViewById(R.id.tv_fileTitle);
			viewHolder.ib_download = (ImageButton) convertView.findViewById(R.id.ib_download);
		...
		final FileUtils fileUtils = new FileUtils(viewHolder.downloadProgress, context, viewHolder.ib_download);
		...
		viewHolder.ib_download.setOnClickListener(new OnClickListener()
		{
			...
			{
				// 下载文件
				fileUtils.asyncDownloadFile(bean.getPath(), bean.getName(), bean.getType());
			}
		});
