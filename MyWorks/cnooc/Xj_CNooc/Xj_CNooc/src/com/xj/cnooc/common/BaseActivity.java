...
import com.xj.cnooc.view.chat.CallingCenter;
...
public abstract class BaseActivity extends Activity {
	...
	public CallingCenter playMusic;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		playMusic = CallingCenter.getInstance();
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {// 后退键
			if (getClass().getName().equals("com.xj.cnooc.view.MainGridViewActivity")) {
				if (firstPressed) {
