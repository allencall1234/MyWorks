...
import com.xj.cnooc.common.Settings;
...
public class CallingCenter {
	...
	public void playCallReceivedMusic(Context context) {
		Settings mSettings = Settings.getInstance(context.getApplicationContext());
		if (mSettings.isEnableNotification() && mSettings.isEnableVoice()) {
...
//					mMediaPlayer.start();
		...
		if (mSettings.isEnableNotification() && mSettings.isEnableVirbrator()) {
