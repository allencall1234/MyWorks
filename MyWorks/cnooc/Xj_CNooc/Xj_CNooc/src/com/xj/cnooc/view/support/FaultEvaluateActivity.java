 ...
 * 2015-9-6
 */
public class FaultEvaluateActivity extends BaseFragmentActivity implements OnClickListener{
	private static final String[] TITLE = new String[] {"故障评估列表", "已审批列表"};
	private ViewPager viewPager;//页卡内容  
	private ImageView cursor;// 动画图片  
	private RelativeLayout fault_support_text_layout,finished_fault_support_text_layout;
...
//	private RelativeLayout rellayout_setting;
	...
	protected void initData() {
		...
		fault_support_text_layout.setOnClickListener(new MyOnClickListener(0,viewPager));  
		finished_fault_support_text_layout.setOnClickListener(new MyOnClickListener(1,viewPager));  
