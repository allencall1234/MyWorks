...
public class CustomSwitch extends View implements OnTouchListener {
	...
	private void init() {
		...
		slider_on = BitmapFactory.decodeResource(getResources(), R.drawable.switch_slider_on);
		slider_off = BitmapFactory.decodeResource(getResources(), R.drawable.switch_slider_off);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (downX < (bg_on.getWidth()/2 - slider_on.getWidth()/2)) {
			canvas.drawBitmap(slider_off, downX+getPaddingLeft(),getPaddingTop()+2, null);
		}else {
			canvas.drawBitmap(slider_on, downX+getPaddingLeft(),getPaddingTop()+2, null);
		}
	}
