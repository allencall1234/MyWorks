...
public class DownloadDetailsActivity extends BaseActivity implements OnClickListener
{
...
//	private Button btn_setting;// 设置
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		attList = (ArrayList<AttachmentBean>) getIntent().getSerializableExtra("att_list");
