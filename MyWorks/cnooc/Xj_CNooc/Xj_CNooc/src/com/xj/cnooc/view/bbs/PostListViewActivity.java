 ...
 * 技术区版块Activity:综保、变压器技术讨论区等
 *
 */
public class PostListViewActivity extends BaseActivity implements OnClickListener, IXListViewListener
{
...
//					break;
	...
	private Handler handler = new Handler(new Handler.Callback() 
	{
		...
		public boolean handleMessage(final Message msg)
		{
			...
			{
				case 0:
					UserHttpBiz.queryPostList(curragePage, num, bbsModuleId, "", "", new HttpDataCallBack()
					{
						@Override
						public void HttpSuccess(String _result) 
						{
							...
							// 设置适配器
							adapter = new PostListViewAdapter(getPostListData(_result), context);
...
////									intent.putExtra("bbsTotal", LoginActivity.bbsTotal);
...
//							}
							MyApp.bbsTotal = 0;
							Log.i("msg", "PostListViewActivity : bbsTotal=" + MyApp.bbsTotal);
...
//				flagCode = 0x01;
				initListViewData();
//				Toast.makeText(context, "PostListView返回结果", Toast.LENGTH_SHORT).show();
			}
		}
	}
