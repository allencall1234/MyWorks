...
public class FeedBackAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.feed_back_list_detail,
					null);
			// 获取控件对象
			viewHolder.feed_back_name = (TextView) convertView
					.findViewById(R.id.feed_back_name);
			viewHolder.feed_back_content = (TextView) convertView
					.findViewById(R.id.feed_back_content);
		...
		// 设置文字和图片
		viewHolder.feed_back_name.setText((String) listItems.get(position).get(
				"feed_back_name"));
