 ...
 *         2015-9-7
 */
public class FaultDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			if (msg.what == 0) {
				UserHttpBiz.submitFaultSupportData(Integer.parseInt(fault_id),
						4, et_approval.getText().toString(), titleText,
			...
			if (msg.what == 1) {
				UserHttpBiz.submitEvaluateSupportData(Integer
						.parseInt(fault_id), 4, et_approval.getText()
						.toString(), titleText,
						MyApp.globelUser.getAccountid(),
						new HttpDataCallBack() {
			...
			if (msg.what == 2) {
				UserHttpBiz.getFaultSupportNum(MyApp.globelUser.getAccountid(),
						MyApp.globelUser.getType(), new HttpDataCallBack() {
							...
							public void HttpSuccess(String _result) {
								...
								// {
								// LoginActivity.hitchtotal =
								// object.getInt("hitchtotal");
								// }
								// }
				...
				UserHttpBiz.getFaultSupportNum(MyApp.globelUser.getAccountid(),
						MyApp.globelUser.getType(), new HttpDataCallBack() {
							...
							public void HttpSuccess(String _result) {
								...
								// if (object.getBoolean("status") == true)
								// {
								// LoginActivity.asstotal =
								// object.getInt("asstotal");
								// }
								// }
								// catch (JSONException e)
								// {
	...
	private void init() {
		...
		if (type.equals("故障详情")) {
			...
			tv_runWay.setText("电网运行方式:"
					+ faultSupportModel.getElectricRunTypeName());
			tv_support_expert.setText("支持专家："
					+ faultSupportModel.getProficientName());
			tv_treatment_measures_detail.setText("        "
					+ faultSupportModel.getDescription().trim());
	...
	public void onClick(View v) {
		...
		case R.id.btn_check_approval:
			if (et_approval.getText().toString().equals("")
					|| et_approval.getText().toString() == null) {
		...
		case R.id.btn_download_attachment:
			// Toast.makeText(FaultDetailActivity.this,
			// ""+faultSupportModel.getPath(), 1).show();
			intent = new Intent(FaultDetailActivity.this,
