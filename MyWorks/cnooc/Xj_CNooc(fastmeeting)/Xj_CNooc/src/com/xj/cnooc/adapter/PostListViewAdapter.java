...
/**
 * 
 * @author Administrator 各个版块要展示的帖子列表Adapter
 * 
 *
 */
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.discuss_item_view, null);

			viewHolder = new ViewHolder();
			viewHolder.tv_post_title = (TextView) convertView
					.findViewById(R.id.tv_post_title);
			viewHolder.iv_head_img = (ImageView) convertView
					.findViewById(R.id.iv_head_img);
			viewHolder.tv_post_content = (TextView) convertView
					.findViewById(R.id.tv_post_content);
			viewHolder.tv_poster = (TextView) convertView
					.findViewById(R.id.tv_poster);
			viewHolder.tv_post_time = (TextView) convertView
					.findViewById(R.id.tv_post_time);
			viewHolder.tv_pinglun_account = (TextView) convertView
					.findViewById(R.id.tv_pinglun_account);
		...
		viewHolder.tv_pinglun_account.setText("评论：(" + bean.getAnswerCount()
				+ ")条");

		ImageLoader.getInstance().displayImage(
				HttpURL.SERVICE_URL + bean.getPhoto(), viewHolder.iv_head_img,
