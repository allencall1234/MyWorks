 ...
 *         2015-10-12
 */
public class VideoKnowledgeBaseDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	private void init() {
		...
		video_knowledge_base_tv_originator.setText("标题："
				+ bundle.getString("videoTitle"));
		video_knowledge_base_tv_faultClassify.setText("上传者："
				+ bundle.getString("createName"));
		video_knowledge_base_btn_attachment_name.setText(bundle
				.getString("attachmentName"));
		video_knowledge_base_tv_date.setText("发布时间："
	...
	public void onClick(View v) {
		...
		case R.id.video_knowledge_base_btn_download_attachment:
			intent = new Intent(VideoKnowledgeBaseDetailActivity.this,
		...
		// intent=new Intent();
		// intent.setClass(VideoKnowledgeBaseDetailActivity.this,
